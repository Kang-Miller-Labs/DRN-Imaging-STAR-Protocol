function varargout = caltracer3_beta(varargin)
%Caltracer - Version 3 beta Last Edited 10/30/2013
...
handles.fig = figure('Name', ...
		     ...
		     'ToolBar', 'figure', ...
		     'doublebuffer','on',...
		     'closerequestfcn','caltracer3beta(''ct_ClosingFcn'',gcbo,guidata(gcbo))',...
		     'Resize', 'on', ...
             'units','pixels',...
...
uimenu(handles.menugroup{menu_idx}.file, ...
       ...
       'Callback', 'caltracer3beta(''open_experiment_callback'', gcbo, guidata(gcbo))');
uimenu(handles.menugroup{menu_idx}.file, ...
       'Label', 'Save Experiment', ...
       'Enable', 'off', ...
       'Callback', 'caltracer3beta(''save_experiment_callback'', gcbo, guidata(gcbo))');
uimenu(handles.menugroup{menu_idx}.file, ...
       'Label', 'New CalTracer', ...
       'Enable', 'on', ...
       'Callback', 'caltracer3beta(''new_ct_callback'', gcbo, guidata(gcbo))');
uimenu(handles.menugroup{menu_idx}.file, ...
       'Label', 'Quit', ...
       'Callback', 'caltracer3beta(''ct_ClosingFcn'', gcbo, guidata(gcbo))');
...
uimenu(handles.menugroup{menu_idx}.preferences, ...
       ...
       'Callback', 'caltracer3beta(''ct_preferences_gui_callback'', gcbo, guidata(gcbo))', ...
       'Enable', 'on');
uimenu(handles.menugroup{menu_idx}.preferences, ...
       'Label', 'Long Raster', ...
       'Callback', 'caltracer3beta(''long_raster_callback'', gcbo, guidata(gcbo))', ...
       'Checked', 'on', ...
       'Enable', 'off');

uimenu(handles.menugroup{menu_idx}.preferences, ...
       'Label', 'Display centroids on selected (pixels)', ...
       'Callback', 'caltracer3beta(''display_centroids_on_selection_callback'',gcbo,guidata(gcbo))',...
       'Enable', 'off');
uimenu(handles.menugroup{menu_idx}.preferences, ...
       'Label', 'Display ids on all contours', ...
       'Callback', 'caltracer3beta(''display_ids_on_all_contours_callback'',gcbo,guidata(gcbo))',...
       'Enable', 'off');
uimenu(handles.menugroup{menu_idx}.preferences, ...
       'Label', 'Display ids on selected contours', ...
       'Callback', 'caltracer3beta(''display_ids_on_selected_contours_callback'',gcbo,guidata(gcbo))',...
       'Enable', 'off');
uimenu(handles.menugroup{menu_idx}.preferences, ...
       'Label', 'Show ordering line', ...
       'Callback', 'caltracer3beta(''show_ordering_line_callback'', gcbo, guidata(gcbo))', ...
       'Enable', 'off');
uimenu(handles.menugroup{menu_idx}.preferences, ...
       'Label', 'Show contour ordering', ...
       'Callback', 'caltracer3beta(''show_contour_ordering_callback'',gcbo,guidata(gcbo))',...
       'Enable', 'off');
...
uimenu(handles.menugroup{menu_idx}.export, ...
       ...
       'Enable', 'On', ...
       'Callback', 'caltracer3beta(''copy_axis_as_meta_to_clipboard_callback'',gcbo,guidata(gcbo))');
uimenu(handles.menugroup{menu_idx}.export, ...
       'Label', 'Copy axis to new figure', ...
       'Enable', 'On', ...
       'Callback', 'caltracer3beta(''copy_axis_to_new_figure_callback'',gcbo,guidata(gcbo))');
uimenu(handles.menugroup{menu_idx}.export, ...
       'Label', 'Export contours', ...
       'Enable', 'Off', ...
       'Callback', 'caltracer3beta(''export_contours_callback'', gcbo, guidata(gcbo))');
uimenu(handles.menugroup{menu_idx}.export, ...
       'Label', 'Export contours to file', ...
       'Enable', 'Off', ...
       'Callback', 'caltracer3beta(''export_contours_to_file_callback'', gcbo, guidata(gcbo))');
uimenu(handles.menugroup{menu_idx}.export, ...
       'Label', 'Export traces', ...
       'Enable', 'Off', ...
       'Callback', 'caltracer3beta(''export_traces_callback'',gcbo,guidata(gcbo))');
uimenu(handles.menugroup{menu_idx}.export, ...
       'Label', 'Export traces with signals', ...
       'Enable', 'Off', ...
       'Callback', 'caltracer3beta(''export_traces_with_signals_callback'',gcbo,guidata(gcbo))');
uimenu(handles.menugroup{menu_idx}.export, ...
       'Label', 'Export active cell traces', ...
       'Enable', 'Off', ...
       'Callback', 'caltracer3beta(''export_active_cell_traces_callback'',gcbo,guidata(gcbo))');
uimenu(handles.menugroup{menu_idx}.export, ...
    'Label', 'All centroids to vnt file', ...
    'Enable', 'Off', ...
    'Callback', 'caltracer3beta(''all_centroids_to_vnt_callback'',gcbo,guidata(gcbo))');
uimenu(handles.menugroup{menu_idx}.export, ...
    'Label', 'All centroids to vnt file (more than once)', ...
    'Enable', 'Off', ...
    'Callback', 'caltracer3beta(''all_centroids_to_vnt_repeat_callback'',gcbo,guidata(gcbo))');
uimenu(handles.menugroup{menu_idx}.export, ...
    'Label', 'All centroids to vnt file (more than one pulse per target)', ...
    'Enable', 'Off', ...
    'Callback', 'caltracer3beta(''all_centroids_to_vnt_pulses_callback'',gcbo,guidata(gcbo))');
uimenu(handles.menugroup{menu_idx}.export, ...
    'Label', 'Active cells to vnt file', ...
    'Enable', 'Off', ...
    'Callback', 'caltracer3beta(''active_cells_to_vnt_callback'',gcbo,guidata(gcbo))');
uimenu(handles.menugroup{menu_idx}.export, ...
    'Label', 'Export ids of overlapping masks', ...
    'Enable', 'Off', ...
    'Callback', 'caltracer3beta(''overlapping_mask_ids_callback'',gcbo,guidata(gcbo))');
...
uimenu(handles.menugroup{menu_idx}.preprocessing, ...
       ...
       'Callback', 'caltracer3beta(''preprocessing_options_callback'', gcbo, guidata(gcbo))',...
       'Enable', 'off');
...
uimenu(handles.menugroup{menu_idx}.contours, ...
       'Label', 'Tile Region', ...
       'Callback', 'caltracer3beta(''tile_region_callback'', gcbo, guidata(gcbo))', ...
       'Enable', 'off');
uimenu(handles.menugroup{menu_idx}.contours, ...
       'Label', 'Tile Region at angle', ...
       'Callback', 'caltracer3beta(''tile_region_angle_callback'', gcbo, guidata(gcbo))', ...
       'Enable', 'off');
uimenu(handles.menugroup{menu_idx}.contours, ...
       'Label', 'Tile Region with rectangles',...
       'Callback', ...
       'caltracer3beta(''tile_region_with_rectangles_callback'',gcbo, guidata(gcbo))',...
       'Enable', 'off');
uimenu(handles.menugroup{menu_idx}.contours, ...
       'Label', 'Randomize contour order',...
       'Callback', ...
       'caltracer3beta(''randomize_contour_order_callback'',gcbo, guidata(gcbo))',...
       'Enable', 'off');
uimenu(handles.menugroup{menu_idx}.contours, ...
       'Label', 'Keep only brightest contours',...
       'Callback', ...
       'caltracer3beta(''keep_only_brightest_contours_callback'',gcbo, guidata(gcbo))',...
       'Enable', 'off');
uimenu(handles.menugroup{menu_idx}.contours, ...
       'Label', 'Keep random contours',...
       'Callback', ...
       'caltracer3beta(''keep_random_contours_callback'',gcbo, guidata(gcbo))',...
       'Enable', 'off');
uimenu(handles.menugroup{menu_idx}.contours, ...
       'Label', 'Keep last contours',...
       'Callback', ...
       'caltracer3beta(''keep_last_contours_callback'',gcbo, guidata(gcbo))',...
       'Enable', 'off');
uimenu(handles.menugroup{menu_idx}.contours, ...
       'Label', 'Keep last contours & randomize order',...
       'Callback', ...
       'caltracer3beta(''keep_last_contours_randomize_callback'',gcbo, guidata(gcbo))',...
       'Enable', 'off');
uimenu(handles.menugroup{menu_idx}.contours, ...
       'Label', 'Convert contours to parallel image',...
       'Callback', ...
       'caltracer3beta(''convert_contours_to_parallel_image_callback'',gcbo, guidata(gcbo))',...
       'Enable', 'off');   
uimenu(handles.menugroup{menu_idx}.contours, ...
   'Label', 'Make all contours active', ...
   'Callback', 'caltracer3beta(''make_all_contours_active_callback'',gcbo,guidata(gcbo))',...
   'Enable', 'off');
uimenu(handles.menugroup{menu_idx}.contours, ...
       'Label', 'Highlight contours by order', ...
       'Callback','caltracer3beta(''highlight_contours_by_order_callback'',gcbo,guidata(gcbo))',...
       'Enable', 'off');
uimenu(handles.menugroup{menu_idx}.contours, ...
       'Label', 'Highlight contours by order (in partition)', ...
       'Callback','caltracer3beta(''highlight_contours_by_order_in_partition_callback'',gcbo,guidata(gcbo))',...
       'Enable', 'off');
uimenu(handles.menugroup{menu_idx}.contours, ...
       'Label', 'Highlight contours by cluster id', ...
       'Callback','caltracer3beta(''highlight_contours_by_cluster_id_callback'',gcbo,guidata(gcbo))', ...
       'Enable', 'off');
uimenu(handles.menugroup{menu_idx}.contours, ...
       'Label', 'Connect highlighted contours in order', ...
       'Callback', 'caltracer3beta(''connect_highlighted_contours_in_order_callback'',gcbo,guidata(gcbo))',...
       'Enable', 'off');
uimenu(handles.menugroup{menu_idx}.contours, ...
       'Label', 'Plot highlighted contours', ...
       'Callback', 'caltracer3beta(''plot_highlighted_contours_callback'',gcbo,guidata(gcbo))',...
       'Enable', 'off');
uimenu(handles.menugroup{menu_idx}.contours, ...
       'Label', 'Plot highlighted contours with zeroed signals', ...
       'Callback', 'caltracer3beta(''plot_highlighted_contours_zero_callback'',gcbo,guidata(gcbo))',...
       'Enable', 'off');      
uimenu(handles.menugroup{menu_idx}.contours, ...
       'Label', 'Turn active contours off', ...
       'Callback', 'caltracer3beta(''turn_active_contours_off_callback'',gcbo,guidata(gcbo))',...
       'Enable', 'off');
uimenu(handles.menugroup{menu_idx}.contours, ...
       'Label', 'Delete contour by id', ...
       'Callback', 'caltracer3beta(''delete_contours_by_id_callback'',gcbo,guidata(gcbo))',...
       'Enable', 'off');   
uimenu(handles.menugroup{menu_idx}.contours, ...
       'Label', 'Delete active contours', ...
       'Callback', 'caltracer3beta(''delete_active_contours_callback'',gcbo,guidata(gcbo))',...
       'Enable', 'off'); 
...
uimenu(handles.menugroup{menu_idx}.clustering, ...
       ...
       'Callback', 'caltracer3beta(''highlight_all_clusters_callback'',gcbo,guidata(gcbo))',...
       'Enable', 'off');
uimenu(handles.menugroup{menu_idx}.clustering, ...
       'Label', 'Unhighlight all clusters', ...
       'Callback', 'caltracer3beta(''unhighlight_all_clusters_callback'',gcbo,guidata(gcbo))',...
       'Enable', 'off');
uimenu(handles.menugroup{menu_idx}.clustering, ...
       'Label', 'Merge highlighted clusters', ...
       'Callback', 'caltracer3beta(''merge_highlighted_clusters_callback'',gcbo,guidata(gcbo))',...
       'Enable', 'off');
uimenu(handles.menugroup{menu_idx}.clustering, ...
       'Label', 'Delete clusters by id', ...
       'Callback', 'caltracer3beta(''delete_clusters_by_id_callback'',gcbo,guidata(gcbo))', ...
       'Enable', 'off');
uimenu(handles.menugroup{menu_idx}.clustering, ...
       'Label', 'Delete clusters by size', ...
       'Callback', 'caltracer3beta(''delete_clusters_by_size_callback'',gcbo,guidata(gcbo))', ...
       'Enable', 'off');
uimenu(handles.menugroup{menu_idx}.clustering, ...
       'Label', 'Delete contours by order', ...
       'Callback','caltracer3beta(''delete_contours_by_order_callback'',gcbo,guidata(gcbo))',...
       'Enable', 'off');
uimenu(handles.menugroup{menu_idx}.clustering, ...
       'Label', 'Order clusters by intensity peak', ...
       'Callback', 'caltracer3beta(''order_clusters_by_intensity_peak_callback'',gcbo,guidata(gcbo))',...
       'Enable', 'off');
...
for i = 1:length(st)
   uimenu(handles.menugroup{menu_idx}.functions, ...
       ...
       'Callback', 'caltracer3beta(''signal_functions_callback'',gcbo,guidata(gcbo))');
end
...
handles.uigroup{lidx}.authors = ...
    uicontrol('Style','text', ...
	      'Units','normalized', ...
	      'String',{'by Mor Dar, David Sussillo, Dmitry Aronov,';'Brendon Watson, Adam Packer';'Conrad Stern-Ascher, and Ben Shababo'}, ...
	      'Position',[.25 .2 .4 .05], ...
...
%% Image Window
% This is the initial view within caltracer3beta.
...
handles.uigroup{lidx}.bopenimage = ...
    uicontrol('Style','pushbutton', ...
	      ...
	      'FontSize',9, ...
	      'Callback','caltracer3beta(''open_image_callback'',gcbo,guidata(gcbo))');
...
handles.uigroup{lidx}.bopenimage = ...
    uicontrol('Style','pushbutton', ...
	      ...
	      'FontSize',9, ...
	      'Callback','caltracer3beta(''open_image_sequence_callback'',gcbo,guidata(gcbo))');
...
handles.uigroup{lidx}.bbright = ...
    uicontrol('Style','slider', ...
	      ...
	      'Value',1/3, ...
	      'Enable','off', ...
	      'Callback','caltracer3beta(''adjust_contrast_callback'',gcbo,guidata(gcbo))');
...
handles.uigroup{lidx}.bnext = ...
    uicontrol('Style','pushbutton', ...
	      ...
	      'FontSize',9, ...
	      'Enable','off', ...
	      'Callback','caltracer3beta(''setup_regions_callback'',gcbo,guidata(gcbo))');
...
handles.uigroup{lidx}.bord_add = ...
    uicontrol('Style','pushbutton', ...
	      ...
	      'Visible', 'Off', ...
	      'Enable','on', ...
	      'Callback','caltracer3beta(''create_region_callback'',gcbo,guidata(gcbo))');
...
handles.uigroup{lidx}.bord_delete = ...
    uicontrol('Style','pushbutton', ...
	      ...
	      'Visible', 'Off', ...
	      'Enable','off', ...
	      'Callback','caltracer3beta(''delete_region_callback'',gcbo,guidata(gcbo))');
...
handles.uigroup{lidx}.bnext = ...
    uicontrol('Style','pushbutton', ...
	      ...
	      'Enable','on', ...
	      'Visible', 'Off', ...	     
	      'Callback','caltracer3beta(''name_regions'',gcbo,guidata(gcbo))');
...
handles.uigroup{lidx}.det_loc = ...
    uicontrol('Style','pushbutton', ...
	      ...
	      'FontSize',9, ...
	      'Visible', 'Off', ...	     
	      'Callback','caltracer3beta(''ct_filter_callback'',gcbo,guidata(gcbo))');
...
handles.uigroup{lidx}.det_view = ...
    uicontrol('Style','pushbutton', ...
	      ...
	      'FontSize',9, ...
	      'Visible', 'Off', ...	     
	      'Callback','caltracer3beta(''view_filtered_image'',gcbo,guidata(gcbo))',...
	      'enable','off');
...
handles.uigroup{lidx}.leftcols = ...
    uicontrol('Style','edit', ...
	      ...
	      'HorizontalAlignment','left',...
          'tag','leftcols',...
          'Callback','caltracer3beta(''show_save_bad_pixels_callback'',gcbo,guidata(gcbo))'); 
...
handles.uigroup{lidx}.btdetect = ...
    uicontrol('Style','pushbutton', ...
	      ...
	      'FontSize',9,...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''detect_cells_callback'',gcbo,guidata(gcbo))');
handles.uigroup{lidx}.bthide = ...
    uicontrol('Style','pushbutton', ...
	      ...
	      'FontSize',9,...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''bthide_callback'',gcbo,guidata(gcbo))');
...
handles.uigroup{lidx}.btfindbad = ...
    uicontrol('Style','pushbutton', ...		      
	      ...
	      'FontSize',9,...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''find_bad_cells_callback'',gcbo,guidata(gcbo))');
handles.uigroup{lidx}.btdilate = ...
    uicontrol('Style','pushbutton', ...		      
	      'Units','normalized', ...
	      'String','Dilate', ...
	      'Position',[.87 .255 .05 0.03], ...
	      'FontSize',9,...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''dilate_contours_callback'',gcbo,guidata(gcbo))');
handles.uigroup{lidx}.btadjust = ...
    uicontrol('Style','pushbutton', ...
	      ...
	      'FontSize',9,...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''adjust_contours_callback'',gcbo,guidata(gcbo))');
handles.uigroup{lidx}.btdeletepi = ...
    uicontrol('Style','pushbutton', ...
	      ...
	      'FontSize',9,...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''delete_high_pi_contours_callback'',gcbo,guidata(gcbo))');
...
handles.uigroup{lidx}.moveall = ...
    uicontrol('Style','pushbutton', ...
	      ...
	      'FontSize',9,...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''move_all_contours_callback'',gcbo,guidata(gcbo))');
handles.uigroup{lidx}.rotateall = ...
    uicontrol('Style','pushbutton', ...
	      ...
	      'FontSize',9,...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''rotate_all_contours_callback'',gcbo,guidata(gcbo))');
handles.uigroup{lidx}.moveone = ...
    uicontrol('Style','pushbutton', ...
	      ...
	      'FontSize',9,...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''move_one_contour_callback'',gcbo,guidata(gcbo))');
...
handles.uigroup{lidx}.shaperad1 = ...
    uicontrol('Style','radiobutton', ...
	      ...
	      'Value',1, ...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''detectcells_shaperad1_callback'',gcbo,guidata(gcbo))');
handles.uigroup{lidx}.shaperad2 = ...
    uicontrol('Style','radiobutton', ...
	      ...
	      'Value',0, ...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''detectcells_shaperad2_callback'',gcbo,guidata(gcbo))');
handles.uigroup{lidx}.shaperad3 = ...
    uicontrol('Style','radiobutton', ...
	      ...
	      'Value',0, ...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''detectcells_shaperad3_callback'',gcbo,guidata(gcbo))');
handles.uigroup{lidx}.btadd = ...
    uicontrol('Style','togglebutton', ...
	      ...
	      'FontSize',9,...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''manual_contour_add_callback'',gcbo,guidata(gcbo))');
handles.uigroup{lidx}.btdelete = ...
    uicontrol('Style','togglebutton', ...
	      ...
	      'FontSize',9,...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''manual_contour_delete_callback'',gcbo,guidata(gcbo))',...
	      'enable','off');
handles.uigroup{lidx}.bteditcontours = ...
    uicontrol('Style','pushbutton', ...
	      ...
	      'FontSize',9,...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''edit_contour_callback'',gcbo,guidata(gcbo))',...
	      'enable','off');      
handles.uigroup{lidx}.btloadcontours = ...
    uicontrol('Style','pushbutton', ...
	      ...
	      'FontSize', 9, ...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''load_contours_callback'',gcbo,guidata(gcbo))');
...
handles.uigroup{lidx}.btnextscr = ...
    uicontrol('Style','pushbutton', ...
	      ...
	      'FontSize',9,...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''detect_cells_next_callback'',gcbo,guidata(gcbo))', ...
 	      'enable','off');
...
handles.uigroup{lidx}.classifyoverlap = ...
   uicontrol('Style','radiobutton', ...
	      ...
	      'Value',1, ...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''classifyoverlap_callback'',gcbo,guidata(gcbo))');
...
handles.uigroup{lidx}.eliminaterest = ...
    uicontrol('Style','radiobutton', ...
	      ...
	      'Value',0, ...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''eliminaterest_callback'',gcbo,guidata(gcbo))');
handles.uigroup{lidx}.eliminateoverlap = ...
    uicontrol('Style','radiobutton', ...
	      ...
	      'Value',0, ...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''eliminateoverlap_callback'',gcbo,guidata(gcbo))');
handles.uigroup{lidx}.btfindbad = ...
    uicontrol('Style','pushbutton', ...		      
	      'Units','normalized', ...
	      'String','Find', ...
	      ...
	      'FontSize',9,...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''find_overlap_callback'',gcbo,guidata(gcbo))');
handles.uigroup{lidx}.btdilate = ...
    uicontrol('Style','pushbutton', ...		      
	      'Units','normalized', ...
	      'String','Dilate', ...
	      'Position',[.945 .26 .05 0.03], ...
	      'FontSize',9,...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''dilate_contours_callback'',gcbo,guidata(gcbo))');
handles.uigroup{lidx}.btadjust = ...
    uicontrol('Style','pushbutton', ...
	      ...
	      'FontSize',9,...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''adjust_overlap_callback'',gcbo,guidata(gcbo))');
...
handles.uigroup{lidx}.moveall = ...
    uicontrol('Style','pushbutton', ...
	      ...
	      'FontSize',9,...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''move_all_contours2_callback'',gcbo,guidata(gcbo))');
handles.uigroup{lidx}.rotateall = ...
    uicontrol('Style','pushbutton', ...
	      'Units','normalized', ...
	      'String','Rotate All', ...
	      ...
	      'FontSize',9,...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''rotate_all_contours2_callback'',gcbo,guidata(gcbo))');
handles.uigroup{lidx}.shaperad1 = ...
    uicontrol('Style','radiobutton', ...
	      'Units','normalized', ...
	      'String','Circle', ...
	      ...
	      'Value',1, ...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''consolidatemaps_shaperad1_callback'',gcbo,guidata(gcbo))');
handles.uigroup{lidx}.shaperad2 = ...
    uicontrol('Style','radiobutton', ...
	      'Units','normalized', ...
	      'String','Freehand', ...
	      ...
	      'Value',0, ...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''consolidatemaps_shaperad2_callback'',gcbo,guidata(gcbo))');
handles.uigroup{lidx}.shaperad3 = ...
    uicontrol('Style','radiobutton', ...
	      'Units','normalized', ...
	      'String','Custom', ...
	      ...
	      'Value',0, ...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''consolidatemaps_shaperad3_callback'',gcbo,guidata(gcbo))');
handles.uigroup{lidx}.btadd = ...
    uicontrol('Style','togglebutton', ...
	      'Units','normalized', ...
	      'String','Add', ...
...
handles.uigroup{lidx}.btsplit = ...
    uicontrol('Style','pushbutton', ...
	      ...
	      'FontSize',9,...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''mask_split_callback'',gcbo,guidata(gcbo))');    
handles.uigroup{lidx}.btnextscr = ...
    uicontrol('Style','pushbutton', ...
	      'Units','normalized', ...
	      'String','Next >>', ...
	      ...
	      'FontSize',9,...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''setup_halos_callback'',gcbo,guidata(gcbo))', ...
 	      'enable','on');
handles.uigroup{lidx}.adddeletetext = ...
    uicontrol('Style','text', ...
	      'Units','normalized', ...
...
handles.uigroup{lidx}.halo_check = ...
    uicontrol('Style','checkbox', ...
	      ...
	      'BackgroundColor',[.8 .8 .8], ...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''halo_check_callback'',gcbo,guidata(gcbo))');
% handles.uigroup{lidx}.halo_swiss_check = ...
%     uicontrol('Style','checkbox', ...
% 	      'Units','normalized', ...
% 	      'String','Swiss-cheese halos', ...
% 	      'Value', 1, ...
% 	      'Position',[.87 .6875 .11 0.025], ...
% 	      'FontSize',9,...
% 	      'BackgroundColor',[.8 .8 .8], ...
% 	      'Visible', 'off', ...
% 	      'Callback','caltracer3beta(''halo_check_callback'',gcbo,guidata(gcbo))');      
...
handles.uigroup{lidx}.dummy(2) = ...
    uicontrol('Style','text', ...
	      'Units','normalized', ...
	      'String','Padding area', ...
	      'Position',[.87 0.64 .11 0.02], ...
	      'FontSize',9,...
	      'HorizontalAlignment','left', ...
	      'Visible', 'off', ...
	      'BackgroundColor',[.8 .8 .8]);      
handles.uigroup{lidx}.halocellpadding = ...
    uicontrol('Style','edit', ...
	      'Units','normalized', ...
	      'String', '.5', ...
	      'Position',[.87 0.615 .11 0.025], ...
	      'FontSize',9,...
	      'BackgroundColor',[1 1 1], ...
	      'HorizontalAlignment','left', ...
	      'Visible', 'off', ...
...
handles.uigroup{lidx}.btupdate = ...
    uicontrol('Style','pushbutton', ...
	      'Units','normalized', ...
	      'String','Update', ...
	      'Position',[.93 .57 .05 0.03], ...
	      'FontSize',9,...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''halo_update_callback'',gcbo,guidata(gcbo))',...
	      'enable','on');
% handles.uigroup{lidx}.dummy(3) = ...
%     uicontrol('Style','text', ...
% 	      'Units','normalized', ...
% 	      'String','Trace reader', ...
% 	      'Position',[.87 0.52 .11 0.02], ...
% 	      'FontSize',9,...
% 	      'HorizontalAlignment','left', ...
% 	      'Visible', 'off', ...
% 	      'BackgroundColor',[.8 .8 .8]);
...
handles.uigroup{lidx}.bnext = ...
    uicontrol('Style','pushbutton', ...
	      ...
	      'FontSize',9, ...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''setup_signals_callback'',gcbo,guidata(gcbo))');
...
handles.uigroup{lidx}.trace_check = ...
    uicontrol('Style','checkbox', ...
	      ...
	      'UserData', 1, ...
	      'Callback','caltracer3beta(''trace_check_callback'',gcbo,guidata(gcbo))');
handles.uigroup{lidx}.clean_trace_check = ...
    uicontrol('Style','checkbox', ...
	      ...
	      'UserData', 2, ...
	      'BackgroundColor',[.8 .8 .8], ...
	      'Callback','caltracer3beta(''clean_trace_check_callback'',gcbo,guidata(gcbo))');
handles.uigroup{lidx}.halo_raw_check = ...
    uicontrol('Style','checkbox', ...
	      ...
	      'UserData', 1, ...
	      'BackgroundColor',[.8 .8 .8], ...
	      'Callback','caltracer3beta(''halo_raw_callback'',gcbo,guidata(gcbo))');
handles.uigroup{lidx}.halo_preprocess_check = ...
    uicontrol('Style','checkbox', ...
	      ...
	      'Visible', 'off', ...
	      'BackgroundColor',[.8 .8 .8], ...
	      'Callback','caltracer3beta(''halo_preprocess_callback'',gcbo,guidata(gcbo))');
handles.uigroup{lidx}.signals_check = ...
    uicontrol('Style','checkbox', ...
	      ...
	      'Visible', 'off', ...
	      'BackgroundColor',[.8 .8 .8], ...
	      'Callback','caltracer3beta(''signals_checkbox_callback'',gcbo,guidata(gcbo))');
...
handles.uigroup{lidx}.use_frame_click_input_checkbox = ...
    uicontrol('Style','checkbox', ...
          ...
          'Value',0,...
	      'BackgroundColor',[.8 .8 .8],...
          'Callback','caltracer3beta(''click_frame_input_callback'',gcbo,guidata(gcbo))');
handles.uigroup{lidx}.use_numerical_frame_input_checkbox = ...
    uicontrol('Style','checkbox', ...
          ...
          'Value',0,...
	      'BackgroundColor',[.8 .8 .8],...
          'Callback','caltracer3beta(''numerical_frame_input_callback'',gcbo,guidata(gcbo))');
...
handles.uigroup{lidx}.numslider = ...
    uicontrol('Style','slider', ...
	      ...
	      'Callback','caltracer3beta(''numslider_callback'',gcbo,guidata(gcbo))', ... 
	      'Min', 0, ...
	      'Max', 1, ...		% (Uninitialized)
...
handles.uigroup{lidx}.btcluster = ...
    uicontrol('Style','pushbutton', ...
	      ...
	      'FontSize',9,...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''cluster_callback'',gcbo,guidata(gcbo))');
...
handles.uigroup{lidx}.clusterpopup = ...
    uicontrol('Style','popupmenu', ...
	      ...
	      'FontSize',9,...
	      'Visible', 'Off', ...	
	      'Callback', 'caltracer3beta(''clusterpopup_callback'',gcbo,guidata(gcbo))',...
	      'BackgroundColor',[1 1 1]);
...
handles.uigroup{lidx}.btreorder = ...
    uicontrol('Style','pushbutton', ...
	      ...
	      'FontSize',9,...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''order_contours_callback'',gcbo,guidata(gcbo))');
...
handles.uigroup{lidx}.contourorderpopup = ...
    uicontrol('Style','popupmenu', ...
	      ...
	      'FontSize',9,...
	      'Visible', 'Off', ...	
	      'Callback', 'caltracer3beta(''contour_order_popup_callback'',gcbo,guidata(gcbo))',...
	      'BackgroundColor',[1 1 1]);
...
handles.uigroup{lidx}.btdetect = ...
    uicontrol('Style','pushbutton', ...
	      ...
	      'FontSize',9,...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''detect_signals_callback'',gcbo,guidata(gcbo))');
...
handles.uigroup{lidx}.signalspopup = ...
    uicontrol('Style','popupmenu', ...
	      ...
	      'FontSize',9,...
	      'Visible', 'Off', ...	
	      'Callback', 'caltracer3beta(''signals_popup_callback'',gcbo,guidata(gcbo))',...
	      'BackgroundColor',[1 1 1]);
...
handles.uigroup{lidx}.btexporttoanalyzer = ...
    uicontrol('Style','pushbutton', ...
	      ...
	      'FontSize',9,...
	      'Visible', 'off', ...
	      'Callback','caltracer3beta(''export_signals_to_analyzer_callback'',gcbo,guidata(gcbo))');
handles.uigroup{lidx}.signaleditmodecheckbox = ...
    uicontrol('Style','checkbox', ...
	      ...
	      'FontSize',9,...
	      'Visible', 'Off', ...	
          'Callback', 'caltracer3beta(''signal_edit_mode_callback'',gcbo,guidata(gcbo))',...
	      'BackgroundColor',[.8 .8 .8]);    
...
handles.uigroup{lidx}.contourslidercheckbox = ...
    uicontrol('Style','checkbox', ...
	      ...
	      'FontSize',9,...
	      'Visible', 'Off', ...	
          'Callback', 'caltracer3beta(''use_contour_slider_callback'',gcbo,guidata(gcbo))',...
	      'BackgroundColor',[.8 .8 .8]);
...
if handles.app.preferences.SingleRegion == 1||handles.app.info.issplit == 1
    caltracer3beta('name_regions',hObject, handles);
end
...
handles.uigroup{lidx}.bnext = ...
    uicontrol('Style','pushbutton', ...
	      ...
	      'FontSize',9, ...
	      'Enable','on', ...
	      'Callback','caltracer3beta(''setup_filter_image'',gcbo,guidata(gcbo))');
guidata(hObject, handles);
% if the image was a result of splitting, open it automatically.
...
if handles.app.preferences.FilterOnly == 1||handles.app.info.issplit == 1 
  ...
  caltracer3beta('ct_filter_callback',hObject, handles);
end
...
function handles = dilate_contours_callback(hObject, handles)
% This is called when "Dilate" is hit

% do it
handles = dilate_contours(handles);
% Draw updated contours
handles = draw_cell_contours(handles);
guidata(hObject, handles);
...
button_down_fnc = 'caltracer3beta(''consolidate_smmap_buttondown_callback'',gcbo,guidata(gcbo))'; 
mapcl = hsv(nmaps);
for i = 1:nmaps   
...
handles = uiset(handles,'consolidatemaps','btdilate','enable','off');
...
handles = uiset(handles,'consolidatemaps','btdilate','enable','on');
...
caltracer3beta(handlestosplit);
caltracer3beta(handles);
delete (handles.fig);
...
handles = uiset(handles, 'halos', 'halocellpadding', ...
		'String', handles.app.preferences.haloBorderArea);    
...
%    handles = uiset(handles, 'halos', 'halo_swiss_check','enable','off');
    handles = uiset(handles, 'halos', 'halocellpadding','enable','off');
else
...
%    handles = uiset(handles, 'halos', 'halo_swiss_check','enable','on');
    handles = uiset(handles, 'halos', 'halocellpadding','enable','on');
...
% if uiget(handles,'halos','halo_swiss_check','value')
    regions.HaloBorderArea = str2num(uiget(handles,'halos','halocellpadding','string'));
% end
...
%     if uiget(handles,'halos','halo_swiss_check','value')
        halos{c} = (handles.app.experiment.contourLines{c}-ct)*sqrt((1+regions.haloArea))+ct;
        halo_borders{c} = (handles.app.experiment.contourLines{c}-ct)*sqrt((1+regions.HaloBorderArea))+ct;
%     else
...
if get(hObject,'value') == 1;
    ...
    caltracer3beta('use_contour_slider_callback',gcbo,guidata(gcbo))
end
...
if (isfield(savestruct,'handles'))
    ...
    [pathstr, name, ext] = fileparts(which('caltracer3beta'));
...
%% If the experiment was made in caltracer 1.x 
    ...
    if (isfield(savestruct, 'A')&&isfield(savestruct,'E'))
        % An attempt to make Caltracer 3 backwards compatible with old Caltracer
        % experiments.
        % Set up info, data and experiment in Caltracer 2 standards.
        % Information about CalTracer
            info.title = 'CalTracer Beta';
            info.versionNum = 3.0;
...
%% Preferences menu.
% Reads and writes values into caltracer3 preferences to make defaults
